...
// instead of a 404. All loaded through skinUrl() — files live under
// public/skin/ and are generated by scripts/generate-skin.mjs.
const ASSET_BACKGROUND = '5_background.png';
...
export class SongSelectCanvas {
  ...
  /** Static skin PNGs from public/skin/. Populated lazily;
